...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrdenDelivery order1 = new OrdenDelivery("1", null, LocalDate.now(), null, "Order 1", "None", pack1);
        OrdenDelivery order2 = new OrdenDelivery("2", null, LocalDate.now().plusDays(2), null, "Order 2", "None", pack2);
